...
import AuaghoScavengeAuaghoScavengeScavenge from './auagho/scavenge/auagho.scavenge.scavenge'
...
export default { 
  AuaghoScavengeAuaghoScavengeScavenge: load(AuaghoScavengeAuaghoScavengeScavenge, 'auagho.scavenge.scavenge'),
