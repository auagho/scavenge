...
func init() {
	proto.RegisterType((*MsgSubmitScavenge)(nil), "auagho.scavenge.scavenge.MsgSubmitScavenge")
	proto.RegisterType((*MsgSubmitScavengeResponse)(nil), "auagho.scavenge.scavenge.MsgSubmitScavengeResponse")
	proto.RegisterType((*MsgCommitSolution)(nil), "auagho.scavenge.scavenge.MsgCommitSolution")
	proto.RegisterType((*MsgCommitSolutionResponse)(nil), "auagho.scavenge.scavenge.MsgCommitSolutionResponse")
	proto.RegisterType((*MsgRevealSolution)(nil), "auagho.scavenge.scavenge.MsgRevealSolution")
	proto.RegisterType((*MsgRevealSolutionResponse)(nil), "auagho.scavenge.scavenge.MsgRevealSolutionResponse")
}
...
var fileDescriptor_62ec6f1544538068 = []byte{
	...
	,
	...
	0x24, 0xbd, 0xe4, 0xfc, 0x5c, 0x7d, 0x88, 0xc1, 0xfa, 0xf0, 0x6c, 0x57, 0x81, 0x60, 0x96, 0x54,
	0x16, 0xa4, 0x16, 0x27, 0xb1, 0x81, 0x73, 0xa1, 0x31, 0x20, 0x00, 0x00, 0xff, 0xff, 0x55, 0x80,
	0x90, 0x7e, 0x9a, 0x03, 0x00, 0x00,
}
...
func (c *msgClient) SubmitScavenge(ctx context.Context, in *MsgSubmitScavenge, opts ...grpc.CallOption) (*MsgSubmitScavengeResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/auagho.scavenge.scavenge.Msg/SubmitScavenge", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) CommitSolution(ctx context.Context, in *MsgCommitSolution, opts ...grpc.CallOption) (*MsgCommitSolutionResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/auagho.scavenge.scavenge.Msg/CommitSolution", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) RevealSolution(ctx context.Context, in *MsgRevealSolution, opts ...grpc.CallOption) (*MsgRevealSolutionResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/auagho.scavenge.scavenge.Msg/RevealSolution", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_SubmitScavenge_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/auagho.scavenge.scavenge.Msg/SubmitScavenge",
	}
...
func _Msg_CommitSolution_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/auagho.scavenge.scavenge.Msg/CommitSolution",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_RevealSolution_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/auagho.scavenge.scavenge.Msg/RevealSolution",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "auagho.scavenge.scavenge.Msg",
